...
const labelColor = ref("text-white-900"); // Reactive variable for label color
  ...
  <section class="bg-[#22273D] text-white min-h-screen py-8 px-4 md:px-6">
    <div class="container mx-auto">
      ...
      <div class="bg-[#1A1E2A] rounded-lg shadow-lg p-6 md:p-8 mb-6 opacity-90">
        ...
        >
          <label for="link" class="block mb-2 text-sm font-medium">
            Peringatan, semakan ini bukanlah 100% tepat. Sila pastikan
            sepenuhnya dengan menghubungi organisasi yang terbabit.
          </label>
          <div>
            <input
              type="url"
